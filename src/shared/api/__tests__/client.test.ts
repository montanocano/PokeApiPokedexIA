...
describe("API client error interceptor", () => {
  it("normalizes a 4xx response to ApiError with the correct status", async () => {
  ...
  it("normalizes a 5xx response to ApiError with the correct status", async () => {
  ...
  it("normalizes a network error (no response) to ApiError with status 0", async () => {
